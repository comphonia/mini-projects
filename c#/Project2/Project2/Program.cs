...
namespace Project2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"The Subtotal is = {subtotal.ToString("c")} , The discount amount is = {discount.ToString("c")} , The tax owed is = {tax.ToString("c")} , and Total owed is = {total.ToString("c")} ");
